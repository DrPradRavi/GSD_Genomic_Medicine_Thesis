...
def main():
    scripts = ['Part2_gather_sample_csv_files.py','Part3_clean_csv.py','Part4_95%.py',
               'Part5_combining+tallying.py','Part6_cleaning_data.py','Part7_gathering_sample.py',
               'Part8.py','Part8a.py','Part8b_check.py','Part8c_LD_filter.py','Part8d_onehotencoding.py']
