...
# Constants
OUTPUT_DIR = "Part12_Comparison_output"
os.makedirs(OUTPUT_DIR, exist_ok=True)

# Load data
XGB_importance_df = pd.read_csv("Part11_XGB_output/Part11_XGB_all_features_importance.csv")
rf_importance_df = pd.read_csv("Part10_RF_output/Part10_RF_all_features_importance.csv")

# Merge data on feature
merged_df = pd.merge(XGB_importance_df, rf_importance_df, on='feature', suffixes=('_XGB', '_rf'))

# Load top features
XGB_top_features = pd.read_csv("Part11_XGB_output/Part11_XGB_top_features_importance.csv")
rf_top_features = pd.read_csv("Part10_RF_output/Part10_RF_top_features_importance.csv")
