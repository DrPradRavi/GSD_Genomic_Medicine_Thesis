...
def main():
    scripts = ['Part2_gather_sample_csv_files.py','Part3_clean_csv.py','Part4_95%.py','Part5_combining+tallying.py','Part6_cleaning_data.py','Part7_gathering_sample.py','Part8.py','Part8a.py','Part8b_check.py',
    'Part9_TuRF_4000.py','Part10_RF_ML.py','Part11_XGB.py','Part12_RFvsXGBshap.py', 
    'Part9_RF_FS.py','Part10_RF_ML_RFFS.py','Part11_XGB_RFFS.py','Part12_RFvsXGBshap_RFFS.py',
    'Part13_merger.py','Part14_MI.py','Part15_ENSEMBL.py','Part16_renamer.py']
