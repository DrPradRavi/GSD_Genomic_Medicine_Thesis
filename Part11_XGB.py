...
# File paths
input_csv_selected_features = "Part9_TuRF_feature_selection_results/Part9_selected_features.csv"
output_dir = "Part11_XGB_output"
...
original_df = pd.read_csv("Part9_TuRF_feature_selection_results/Part9_selected_features.csv", index_col=0)
